...
public class StageSelectOptionUIToolkit : MonoBehaviour
{
    [SerializeField] private GameObject UIToolkit;

    private VisualElement _panel;
    private VisualElement[] _optionLabels = new VisualElement[3];
    ...
    private void Awake()
    {
        ...
        _optionLabels[2] = root.Q<VisualElement>("OptionLabel2");
    }
